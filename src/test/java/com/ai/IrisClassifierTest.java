...
public class IrisClassifierTest {
	...
	public void irisTest() throws IOException, InterruptedException {
		...
		MultiLayerConfiguration configuration = new NeuralNetConfiguration.Builder().iterations(1000)
				...
				.l2(0.0001).list().layer(0, new DenseLayer.Builder().nIn(FEATURES_COUNT).nOut(3).build())
	...
	@Test
	@DisplayName("+ve:testCNNNetwork")
	public void testCNNNetwork() {
